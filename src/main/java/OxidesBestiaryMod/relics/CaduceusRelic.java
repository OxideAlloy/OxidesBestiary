...
public class CaduceusRelic extends BaseRelic {
    private static final String NAME = "CaduceusRelic"; //The name will be used for determining the image file as well as the ID.
